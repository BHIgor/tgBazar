        ...
        <aside className="menu page__menu" id="menu" >
          ...
          <div className="container menu__container">
              <ul className="menu__nav">
                <NavLink to={`/?${dataDB.listBot[0].nameShop}#back`} className='menu__link'  style={getLinkStyle}>
                ...
                <NavLink to={`/Compare?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                  <li className="menu__item">
                ...
                <NavLink  to={`/Cart?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                  <li className="menu__item">
                ...
                <NavLink to={`/Orders?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                  <li className="menu__item ">
                ...
                { 
                  (dataDB.settings[0].contacts === '') ? null : (
                    <NavLink to={`/Contacts?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item">
                ...
                { 
                  (dataDB.settings[0].help === '') ? null : (
                    <NavLink to={`/Help?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item">
                ...
                { 
                  (dataDB.settings[0].about === '') ? null : (
                    <NavLink to={`/About?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item">
                ...
                { 
                  (dataDB.settings[0].garant === '') ? null : (
                    <NavLink to={`/Garant?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item">
                ...
                { 
                  (dataDB.settings[0].delivery === '') ? null : (
                    <NavLink to={`/Delivery?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item">
                ...
                { 
                  (dataDB.settings[0].pay === '') ? null : (
                    <NavLink to={`/Pay?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item">
                ...
                { 
                  (dataDB.settings[0].obmin === '') ? null : (
                    <NavLink to={`/Obmin?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item ">
                ...
                { 
                  (dataDB.settings[0].grafik === '') ? null : (
                    <NavLink to={`/Grafik?${dataDB.listBot[0].nameShop}`} className='menu__link' style={getLinkStyle}>
                      <li className="menu__item">
